...
public class UnitTests {
    ...
    public Board execute(String boardNotation, int depth) {
        ...
        Move bestMove = search.getBestMove(board, depth);
    ...
    public void testOffset3x3() {
        ...
        Assertions.assertTrue(board.hasDiagonalWin(X_SIDE));
        Assertions.assertFalse(board.hasDiagonalWin(O_SIDE));
        ...
        Assertions.assertTrue(board.hasDiagonalWin(O_SIDE));
        Assertions.assertFalse(board.hasDiagonalWin(X_SIDE));
    }
    ...
    public void testOffset() {
        ...
        Assertions.assertTrue(board.hasDiagonalWin(X_SIDE) && !board.hasDiagonalWin(O_SIDE));
        ...
        Assertions.assertFalse(board.hasDiagonalWin(X_SIDE) && board.hasDiagonalWin(O_SIDE));
    }
    ...
    public void testBoard() {
        ...
        board.setBoardNotation("121000000o");
        Move[] legalMoves = board.generateLegalMoves();
        if (legalMoves.length == 6) {
            for (Move move : legalMoves) {
                Assertions.assertNotSame(Move.NULL_MOVE, move);
            }
        } else {
            Assertions.fail();
        }
    ...
    public void testTranspositionTable() {
        ...
        transpositionTable.write(200, O_SIDE, (short) 9, 20000, new Move(5, 5).getMoveData(), (short) 9);
        ...
        Assertions.assertEquals(-902007277, board.getKey());
